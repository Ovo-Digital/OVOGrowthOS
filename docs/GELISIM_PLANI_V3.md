...
Tarih: 15 Eylül 2026  
Durum: **Sıralı uygulama kullanıcı tarafından onaylandı. Faz 1, Faz 2 ve Faz 3 tamamlandı. Faz 4 sürüyor; alacak yaşı/vade takvimi tamamlanıp doğrulandı. Ödeme sözü ve görev bağlantısı henüz yapılmadı. Faz 5–6 başlamadı.**
...
- **Faz 4 sürüyor:** İlk adım olarak vade yaşlandırması, bugünden ileri 4/8/12 haftalık vade planı ve geriye aynı uzunlukta gerçek ödeme tarihli tahsilat görünümü kodlandı. Her para birimi ayrı; vadesi bilinmeyen/gecikmiş/takvim sonrası alacaklar ayrı tutulur. İnceleme gereken kayıtlar toplamdan çıkarılıp açıkça gösterilir. Bu okuma akışı mevcut tahsilat defterini kullanır, şema veya finansal kayıt değiştirmez. Ödeme sözleri, görüşme/sorumlu kaydı ve takip görevi bağlantısı henüz yok; Faz 4 tamamlanmış sayılmaz.
...
- Faz 5–6 bekliyor. V2'de ertelenmiş yayın/yedek ve canlı entegrasyon işleri kapsam dışı kalır; e-posta sağlayıcısı/bütçe ayrıca onay gerektirir. Commit, push ve uygulamanın canlı yayını yapılmadı.
