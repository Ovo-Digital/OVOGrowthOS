...
Tarih: 15 Eylül 2026  
Durum: **Sıralı uygulama kullanıcı tarafından onaylandı. Faz 1 ve Faz 2 tamamlandı. Faz 3 kodlandı; veritabanı ve kullanıcı akışı doğrulamaları sürüyor. Faz 4–6 henüz uygulanmadı.**
...
- **Faz 3 sürüyor — 17 Eylül:** Kullanıcı onaylı iki görev şablonu, mevcut kapanış görevini değiştirmeden kullanma, haftalık kapasite, görev saat planı ve kaydedilmeyen ek iş ön izlemesi kodlandı. Tekrar görev üretmeme, eski sürümle güncelleme engeli, eksik/sıfır ayrımı ve çalışan değişince planın yeni sorumluya taşınması testlere eklendi. Rehber aynı kapsamda güncellendi. Gerçek veritabanı ve tarayıcı doğrulamaları tamamlanmadan Faz 4'e geçilmez.
- Faz 4–6 bekliyor. V2'de ertelenmiş yayın/yedek ve canlı entegrasyon işleri kapsam dışı kalır; e-posta sağlayıcısı/bütçe ayrıca onay gerektirir. Commit, push ve uygulamanın canlı yayını yapılmadı.
